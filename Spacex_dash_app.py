...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        success_count.columns = ['Launch Site', 'Successes']

        fig = px.pie(success_count, values='Successes', 
        names='Launch Site', 
...
def update_scatter_chart(entered_site, selected_payload):
    if entered_site == 'ALL':
        ...
        and (spacex_df['Payload Mass (kg)'] <= selected_payload[1])]
        ...
        filtered_df = specific_df[(spacex_df['Payload Mass (kg)'] >= selected_payload[0])
        and (spacex_df['Payload Mass (kg)'] <= selected_payload[1])]
